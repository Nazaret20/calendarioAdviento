...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let diasTotalesDeRelacion = Math.floor(
    diasDeRelacion / (1000 * 60 * 60 * 24)
  );
  ...
  const mensajes = {
    "0-100":
      "Nuestro principio es digno de un fic, nos conocimos por culpa de una novelita de dos lesbianas. Y nuestras cabecitas se lo pasaban muy bien ideando cosas...",
    "101-200":
      'He calculado los días, y resulta que en este tramo, a los 132 días contando desde el primer día que empezamos a hablar, nos dijimos las dos al mismo tiempo, el primer "te quiero". Qué bonito, mi vida.',
    "201-300":
      "Y así hemos ido sumando los días hasta hoy, ¡y resulta que lo quiero multiplicar!",
    "301-400":
      "Seguir sumando cada 24 a tu lado, es símbolo de todo el amor que nos tenemos.",
    "401-500":
      "Darme cuenta de tantos días a tu lado, todo lo que pasamos y seguimos más unidas que nunca... Mi patata explota.",
    "501-600":
      "Los siguiente tramos son la evolución de cómo nos transmitimos el amor que sentimos.",
    "601-700": '"Te adoro" sonaba menos fuerte al principio.',
    "701-800":
      '"Te quiero" nos salió tímidamente pero con una fuerza a la altura de nuestro amor.',
    "801-900":
      '"Te amo" llegó con el tiempo para quedarse porque ya nada se puede igualar a lo que sentimos.',
  };
